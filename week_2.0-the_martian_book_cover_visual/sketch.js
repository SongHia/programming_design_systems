...
// var xDist = r.width/24; //creates 6 colums
// var yDist = r.height/48; //creates 12 rows
...
for(var x = 0; x < r.width; x+=xDist)
  {
    for(var y = 0; y < r.height; y+=yDist)
    {
      ...
      //   .fill(color)
      //   .stroke(false);
      // var line2 = r.rect(x+20, y, width2, height2,chunk)
      //   .fill(color)
      //   .stroke(false);
      // var line3 = r.rect(x+40, y, width3, height3,chunk)
      //   .fill(color)
      //   .stroke(false);
      // var line4 = r.rect(x+60, y, width4, height4,chunk)
      //   .stroke(false)
      //   .fill(color);
      // var line5 = r.line(x+65, y, x, y+25, chunk)
